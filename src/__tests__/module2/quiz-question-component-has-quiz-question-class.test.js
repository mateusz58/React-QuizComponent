...
describe('InvoiceEntry Component', () => {
  it('has a InvoiceEntry class that extends Component @quiz-question-component-has-quiz-question-class', () => {
    let file;
    try {
  ...
  it('exports the InvoiceEntry class as default @quiz-question-component-has-quiz-question-class', () => {
    let file;
    try {
      file = fs.readFileSync(__dirname + '/../../InvoiceEntry.js').toString();
    } catch (e) {

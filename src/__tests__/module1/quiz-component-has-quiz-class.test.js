...
describe('QuizQuestion Component', () => {
  it('has a QuizQuestion class that extends Component @quiz-component-has-quiz-class', () => {
    let file;
    try {
  ...
  it('exports the QuizQuestion class as default @quiz-component-has-quiz-class', () => {
    let file;
    try {
      file = fs.readFileSync(__dirname + '/../../QuizQuestion.js').toString();
    } catch (e) {
